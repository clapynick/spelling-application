...
<!-- 
	...
	File: forgotten-password.php
	Author: Ben Tegoni
	Description:
	This will direct people to where people can find out how to retain a forgotten password.
...
<style>	
	...
	/* Main Chrome Button */
	.main-content .password-icon img {
		padding-top: 0px;
		padding-bottom: 0px;
		padding-right: 0px;
		padding-left: 0px;
...
<div class="main-content">
	<div class="password-icon">
		<img src="images/icons/password2-icon.png" alt="Chrome Icon" height="250" width="250">
	</div>
	<div class="main-text-box">
		<center>
			<p>Welcome to Resources2Go Spelling Application</p>
			<p>If you are experiencing difficulties accessing your account,</p>
			<p>Please talk to your teacher so they can get in touch with an website admin.</p>
			<p>Once this has occurred your password will be reset with the requested password you will be required to provide.</p>
		</center>
	</div>
</div>
